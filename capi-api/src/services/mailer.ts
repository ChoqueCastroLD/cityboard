...
const subject = (code: string) => `Tu código para entrar en Capi: ${code}`;

const text = (code: string) => `Tu código para entrar en Capi es ${code}. Caduca en 10 minutos. Si no lo pediste, ignora este correo.`;

const html = (code: string) => `<div style="font-family:system-ui,sans-serif;max-width:420px;margin:auto;padding:24px;color:#111">
<p style="font-size:14px;color:#555;margin:0 0 12px">Capi</p>
